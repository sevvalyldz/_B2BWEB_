...
namespace B2BWEB.DataAccess.Migrations
{
    ...
    [Migration("20240930075737_databaseee")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("B2BWEB.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("B2BWEB.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("B2BWEB.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("B2BWEB.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("B2BWEB.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("B2BWEB.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("B2BWEB.Models.OrderDetail", b =>
                {
                    b.HasOne("B2BWEB.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("B2BWEB.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("B2BWEB.Models.OrderHeader", b =>
                {
                    b.HasOne("B2BWEB.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("B2BWEB.Models.Product", b =>
                {
                    b.HasOne("B2BWEB.Models.Category", "Category")
                        .WithMany()
